...
<%@ Page Language="c#" Inherits="Commanigy.Iquomi.Web.ServiceScopeUpdatePage" CodeFile="service.scope.update.aspx.cs"
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContentArea" Runat="server">
    ...
    <Columns>
        ...
        <asp:templatefield headertext="Select" sortexpression="Select">
			<itemtemplate>
<a href="<%# Link("service.shape.update.aspx", new object[] { service.Id, Eval("Id") }) %>"><%# Eval("Select") %></a>
</itemtemplate>
</asp:templatefield>
