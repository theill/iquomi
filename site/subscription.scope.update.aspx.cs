...
namespace Commanigy.Iquomi.Web {
	...
	/// 
	/// </summary>
	public partial class SubscriptionScopeUpdatePage : Commanigy.Iquomi.Web.WebPage {
		...
		protected void BtnAddItem_Click(object sender, System.EventArgs e) {
			this.Redirect("subscription.shape.create.aspx", new object[] { subscription.Id, scope.Id });
		}
